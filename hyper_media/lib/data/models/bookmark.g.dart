...
const BookmarkSchema = CollectionSchema(
  ...
  links: {
    r'book': LinkSchema(
      id: -8720997352321273893,
      name: r'book',
      target: r'Book',
      single: true,
    ),
    r'chapters': LinkSchema(
      id: 2268459746406224952,
      name: r'chapters',
      target: r'Chapter',
      single: false,
    ),
    r'reader': LinkSchema(
      id: 7551854054855996711,
      name: r'reader',
      target: r'Reader',
      single: true,
    )
...
List<IsarLinkBase<dynamic>> _bookmarkGetLinks(Bookmark object) {
  return [object.book, object.chapters, object.reader];
}
...
void _bookmarkAttach(IsarCollection<dynamic> col, Id id, Bookmark object) {
  ...
  object.reader.attach(col, col.isar.collection<Reader>(), r'reader', id);
}
...
extension BookmarkQueryLinks
    on QueryBuilder<Bookmark, Bookmark, QFilterCondition> {
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> book(
      FilterQuery<Book> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> bookIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'book', 0, true, 0, true);
    });
  }

  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> chapters(
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> chaptersLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> chaptersIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'chapters', 0, true, 0, true);
    });
  }

  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> chaptersIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> chaptersLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> reader(
      FilterQuery<Reader> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'reader');
    });
  }

  QueryBuilder<Bookmark, Bookmark, QAfterFilterCondition> readerIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'reader', 0, true, 0, true);
    });
  }
}
