...
Book _bookDeserialize(
  ...
  final object = Book(
    ...
    host: reader.readString(offsets[5]),
    id: id,
    isDownload: reader.readBool(offsets[6]),
    link: reader.readString(offsets[7]),
    ...
    totalChapters: reader.readLong(offsets[10]),
...
extension BookQueryFilter on QueryBuilder<Book, Book, QFilterCondition> {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'link',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'link',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'link',
        value: '',
  ...
  QueryBuilder<Book, Book, QAfterFilterCondition> linkIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'link',
        value: '',
...
extension BookQuerySortBy on QueryBuilder<Book, Book, QSortBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> sortByLink() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'link', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> sortByLinkDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BookQuerySortThenBy on QueryBuilder<Book, Book, QSortThenBy> {
  ...
  QueryBuilder<Book, Book, QAfterSortBy> thenByLink() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'link', Sort.asc);
    });
  }

  QueryBuilder<Book, Book, QAfterSortBy> thenByLinkDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'link', Sort.desc);
    });
  }
...
extension BookQueryWhereDistinct on QueryBuilder<Book, Book, QDistinct> {
  ...
  QueryBuilder<Book, Book, QDistinct> distinctByLink(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension BookQueryProperty on QueryBuilder<Book, Book, QQueryProperty> {
  ...
  QueryBuilder<Book, String, QQueryOperations> linkProperty() {
    return QueryBuilder.apply(this, (query) {
...
void _readBookSerialize(
  ...
  writer.writeString(offsets[1], object.nameExtension);
  writer.writeDouble(offsets[2], object.offsetLast);
  writer.writeString(offsets[3], object.titleChapter);
}
...
ReadBook _readBookDeserialize(
  ...
  final object = ReadBook(
    ...
    nameExtension: reader.readStringOrNull(offsets[1]),
    offsetLast: reader.readDoubleOrNull(offsets[2]),
    titleChapter: reader.readStringOrNull(offsets[3]),
  );
  return object;
}
