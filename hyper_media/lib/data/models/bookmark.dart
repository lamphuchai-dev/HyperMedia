...
class Bookmark {
  ...
  @override
  String toString() {
    return 'Bookmark(id: $id, name: $name, link: $link, host: $host, author: $author, description: $description, cover: $cover, totalChapter: $totalChapter, latestChapterTitle: $latestChapterTitle, lastCheckTime: $lastCheckTime, currentTitleChapter: $currentTitleChapter, currentIndex: $currentIndex)';
  }
